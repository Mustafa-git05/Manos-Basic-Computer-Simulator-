...
# Importing and reading the program instructions from the file <to run the program change the file path>
p = open(r"C:\Users\user\Downloads\COE341Proj\program4.txt")
for line in p:
...
# Importing and reading the data from the file <to run the program change the file path>
p = open(r"C:\Users\user\Downloads\COE341Proj\data4.txt")
for line in p:
  line_data = line.split() #Splitting the input line by line based on a space
  first = int(line_data[0], 16) #input data as hex
  second = int(line_data[1], 16) #input data as hex
